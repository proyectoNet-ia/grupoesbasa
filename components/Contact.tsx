              ...
              <div className="flex gap-4">
                {socialLinks.map((social) => (
                  <a 
                    ...
                    className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center text-white cursor-pointer hover:bg-[#D92121] transition-all hover:-translate-y-1"
                  >
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="md:col-span-2 pt-4">
                <button 
                  ...
                  className={`w-full py-4 ${isSubmitting ? 'bg-blue-300' : 'bg-blue-950 hover:bg-[#D92121]'} text-white font-bold rounded-xl shadow-xl transition-all uppercase tracking-widest text-xs flex items-center justify-center gap-3 active:scale-95`}
                >
